...
from casf_benchmark.paths import DEFAULT_MASTER_CSV, DEFAULT_PER_LIGAND_LONG_CSV, DEFAULT_ANALYSIS_SOURCES_CONFIG

DEFAULT_CONFIG = DEFAULT_ANALYSIS_SOURCES_CONFIG
